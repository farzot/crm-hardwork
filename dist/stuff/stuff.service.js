...
const stuff_entity_1 = require("./entities/stuff.entity");
const typeorm_2 = require("typeorm");
let StuffService = class StuffService {
    constructor(stuffRepo) {
    ...
    async update(id, updateStuffDto) {
...
exports.StuffService = StuffService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(stuff_entity_1.Stuff)),
